...
class AppointmentRescheduledNotification extends Notification implements ShouldQueue
{
    ...
    public function toTwilio(object $notifiable): TwilioSmsMessage
    {
        ...
        return (new TwilioSmsMessage)
            ->content("{$appointment->dog->name}'s grooming has been rescheduled to {$date} at {$time}. See you then! Any questions? Just give us a call.");
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Appointment Rescheduled for '.$this->appointment->dog->name)
