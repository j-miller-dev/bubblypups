...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/jmillerdev/PhpstormProjects/bubblypups/public/storage' => 'string',
...
'auth.guards.customer.driver','auth.guards.customer.provider','auth.guards.api.driver','auth.guards.api.provider','auth.guards.sanctum.driver',
...
'filesystems.links./home/jmillerdev/PhpstormProjects/bubblypups/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'inertia.history.encrypt','boost.enabled','boost.browser_logs_watcher','ide-helper.filename','ide-helper.models_filename',
...
'boost.browser-logs','login','logout','password.request',
'password.reset','password.email','password.store','customer.register.form','customer.register',
...
'two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','home',
'booking','booking.start','blog','contact','company',
'pricing','dashboard','profile.edit','profile.update','profile.destroy',
'dashboard.bookings','dashboard.dogs','dashboard.calendar','dashboard.availability','customer.login.form',
'customer.login','customer.logout','booking.create','booking.store','booking.available-slots',
'admin.appointments.confirm','admin.appointments.cancel','admin.appointments.reschedule','admin.admin.appointments.available-slots','admin.blocked-times.index',
'admin.blocked-times.store','admin.blocked-times.destroy','verification.notice','verification.verify','password.confirm','password.update','storage.local',);
