...
function Photos({ avatar1, avatar2 }: { avatar1: string; avatar2: string }) {
  return (
...
export function LinkedAvatars({
  avatar1 = '/linked-avatars/customer.jpg',
  avatar2 = '/linked-avatars/manager.jpg',
  className,
}: LinkedAvatarsProps) {
  return (
    <motion.div
      ...
      aria-hidden="true"
      className={clsx('isolate mx-auto grid h-full grid-cols-1', className)}
    >
      <Rings />
      <Photos avatar1={avatar1} avatar2={avatar2} />
      <Checkmark />
    </motion.div>
  )
}
