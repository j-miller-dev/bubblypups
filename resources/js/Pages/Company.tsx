                    ...
                    <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-6 text-lg text-gray-600">
                                At Radiant, we believe in the power of data to transform businesses. Our mission is to
                                provide
                                cutting-edge tools that help sales teams understand their customers better, build
                                meaningful
                                relationships, and close more deals.
                            </p>
                            <p className="mt-4 text-lg text-gray-600">
                                We're committed to innovation, transparency, and delivering exceptional value to our
                                customers.
                            </p>
                        </div>
                        <Image
                        ...
                        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="rounded-lg border border-gray-200 p-8">
                                ...
                                <p className="mt-4 text-gray-600">
                                    We're constantly pushing the boundaries of what's possible to deliver cutting-edge
                                    solutions.
                                </p>
                            </div>
