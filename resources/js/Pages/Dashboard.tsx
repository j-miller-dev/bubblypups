...
const navigation = [
    ...
    { name: 'Bookings', href: '#', icon: UsersIcon, current: false },
    { name: 'Doggie Database', href: '#', icon: FolderIcon, current: false },
    { name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
    { name: 'Money Tracker', href: '#', icon: DocumentDuplicateIcon, current: false },
    { name: 'Inventory', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
